...
const { joinToRoom, deleteAllRooms, createNewRoomInGroupGame, joinToRoomInGroupGame, joinToRoomInOnlineGame, makeAnInviteToGame } = require('../controllers/roomController');
