const { onlineGameBot } = require("../bot/onllineGameBot");
...
console.log(onlineGameBot([
    ...questions.filter(e => e.type === 'true-false').slice(0,4),
    ...questions.filter(e => e.type === 'normal').slice(0,5),
    ...questions.filter(e => e.type === 'multipale').slice(0,2),
]));